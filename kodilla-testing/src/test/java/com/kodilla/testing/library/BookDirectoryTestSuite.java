...
public class BookDirectoryTestSuite {
    ...
    @Test
    void testListBooksWithCondtiotionsReturnList() {
    ...
    void testListBooksInHands(){
        ...
        LibraryUser libraryUser0 = new LibraryUser("Anna","Nowak","123456789");
        LibraryUser libraryUser1 = new LibraryUser("Dawid","Kowalski","234567890");
        LibraryUser libraryUser5 = new LibraryUser("Paweł","Góra","345678901");
