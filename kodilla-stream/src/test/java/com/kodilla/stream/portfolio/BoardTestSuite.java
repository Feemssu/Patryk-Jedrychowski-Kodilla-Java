...
class BoardTestSuite {
    ...
    void testAddTaskListAverageWorkingOnTask(){
        ...
        List<LocalDate> tasksQuantity = project.getTaskLists().stream()
        ...
        double tasksAverage = IntStream.range(0,tasksQuantity.size())
                .map(n->LocalDate.now().getDayOfYear() - tasksQuantity.get(n).getDayOfYear())
                        .average().getAsDouble();
        //Then
        assertEquals(3, tasksQuantity.size());
        assertEquals(10, tasksAverage);
    }
}